        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Kategori Kelas</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title text-right">Daftar Kategori Kelas</h4>
                        <a href="{{ route('course-category.create') }}"  class="btn btn-secondary bg-gradient waves-effect waves-light">Tambah Data</a>
                    </div>
                    <div class="card-body">
        ...
        function Delete(id) {
            Swal.fire({
                ...
                if (isConfirm.isConfirmed == true) {
                    ...
                    jQuery.ajax({
                        url: "{{ route('course-category.index') }}/"+id,
                        data: {
                            id : id
                        },
                        type: 'DELETE',

            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title text-right">Daftar Kategori</h4>
                        <a href="{{ route('category.create') }}"  class="btn btn-secondary bg-gradient waves-effect waves-light">Tambah Data</a>
                    </div>
                    <div class="card-body">

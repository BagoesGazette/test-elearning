            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title text-right">Daftar Kelas</h4>
                        <a href="{{ route('course.create') }}"  class="btn btn-secondary bg-gradient waves-effect waves-light">Tambah Data</a>
                    </div>
                    <div class="card-body">
    ...
    <script>
        var table = $('.datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'mentor.name', name: 'mentor.name'},
